...
EXPECTED_FILES += ["scenes/sheep/sheep.tscn", "scenes/debug/sheep_visual_lab.tscn", "scripts/sheep_visuals/sheep_animation_controller.gd", "scripts/sheep_visuals/sheep_visual_controller.gd", "scripts/debug/sheep_visual_lab.gd", "assets/models/sheep/base/sheep_-_animated_low_poly.glb"]
