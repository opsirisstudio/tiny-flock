# Tiny Flock documentation

## Architecture

- [Genetics architecture](architecture/genetics_architecture.md)
- [Data flow and future visual mapping](architecture/data_flow.md)
- [Flock repository](architecture/flock_repository.md)
